...
def create_homedir(dirname):
    '''create_homedir will create a new directory in the users home folder
    for use with creating the .credentials and .expfactory cache directories.
    If the path already exists, it is simply returned.
    '''
    home_dir = os.path.expanduser('~')
    new_dir = os.path.join(home_dir, dirname)
